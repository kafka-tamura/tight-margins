    ...
    fields: [
      {
        ...
        label: "Headline",
        max: 40,
        placeholder: "Three signs it's working",
      },
      {
        key: "item1_title",
        label: "Item 1 title",
        max: 30,
        placeholder: "People steal your language",
      },
      {
        key: "item1_body",
        ...
        max: 80,
        placeholder:
          "When someone outside your team uses your exact framing without prompting.",
        multiline: true,
      },
      {
        key: "item2_title",
        label: "Item 2 title",
        max: 30,
        placeholder: "Decisions speed up",
      },
      {
        key: "item2_body",
        label: "Item 2 description",
        max: 80,
        placeholder: "The model answers questions before you have to.",
        multiline: true,
      },
      {
        key: "item3_title",
        label: "Item 3 title",
        max: 30,
        placeholder: "Exceptions prove the rule",
      },
      {
        key: "item3_body",
        label: "Item 3 description",
        max: 80,
        placeholder: "Edge cases feel obvious instead of destabilising.",
        multiline: true,
      },
      {
        key: "item4_title",
        label: "Item 4 title (optional)",
        max: 30,
        placeholder: "",
      },
      {
        key: "item4_body",
        label: "Item 4 description (optional)",
        max: 80,
        placeholder: "",
        multiline: true,
      },
      {
        key: "item5_title",
        label: "Item 5 title (optional)",
        max: 30,
        placeholder: "",
      },
      {
        key: "item5_body",
        label: "Item 5 description (optional)",
        max: 80,
        placeholder: "",
        multiline: true,
      },
    ...
    fields: [
      {
        ...
        max: 160,
        placeholder:
          "The best frameworks don't tell you what to think. They tell you what to look at.",
        multiline: true,
      },
      {
        key: "attribution",
      ...
      {
        key: "role",
        label: "Role / source (optional)",
        max: 60,
        placeholder: "Vice Chairman, Berkshire Hathaway",
      },
    ],
  },
  section_divider: {
    ...
    fields: [
      {
        ...
        label: "Headline",
        max: 40,
        placeholder: "Two things we got wrong",
      },
      {
        key: "item1_title",
        label: "Item 1 title",
        max: 35,
        placeholder: "We optimised for speed",
      },
      {
        key: "item1_body",
        label: "Item 1 body",
        max: 140,
        placeholder:
          "Speed is addictive. We shipped fast and assumed the market would reward us. It didn't.",
        multiline: true,
      },
      {
        key: "item2_title",
        label: "Item 2 title",
        max: 35,
        placeholder: "We hired for skill, not fit",
      },
      {
        key: "item2_body",
        label: "Item 2 body",
        max: 140,
        placeholder:
          "Brilliant people in the wrong context become blockers, not builders.",
        multiline: true,
      },
    ],
  },
  three_up: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Item 1 body",
        max: 100,
        placeholder: "Everyone knows what the decision is and why it was made.",
        multiline: true,
      },
      {
        key: "item2_title",
      ...
      },
      {
        ...
        label: "Item 2 body",
        max: 100,
        placeholder: "The edges are defined. You know what's out of scope.",
        multiline: true,
      },
      {
        key: "item3_title",
      ...
      },
      {
        ...
        label: "Item 3 body",
        max: 100,
        placeholder: "Progress is visible. Feedback loops are short.",
        multiline: true,
      },
    ],
  },
    ...
    fields: [
      {
        ...
        label: "Headline",
        max: 40,
        placeholder: "Building frameworks",
      },
      {
        key: "do1",
        label: "Do #1",
        max: 60,
        placeholder: "Start with the decision it needs to support",
      },
      {
        key: "do2",
        label: "Do #2",
        max: 60,
        placeholder: "Test with real edge cases early",
      },
      {
        key: "do3",
        label: "Do #3",
        max: 60,
        placeholder: "Kill your darlings if they don't earn a slot",
      },
      { key: "do4", label: "Do #4 (optional)", max: 60, placeholder: "" },
      {
        ...
        label: "Don't #1",
        max: 60,
        placeholder: "Design for theoretical completeness",
      },
      {
        key: "dont2",
        label: "Don't #2",
        max: 60,
        placeholder: "Add axes to look rigorous",
      },
      {
        key: "dont3",
        label: "Don't #3",
        max: 60,
        placeholder: "Name it before you've validated it",
      },
    ...
    fields: [
      {
        ...
        label: "Header (top)",
        max: 60,
        placeholder: "Let that sink in.",
      },
      {
        key: "callout",
        label: "Callout (bottom, optional)",
        max: 120,
        placeholder:
          "This is what most people get wrong about building in public.",
        multiline: true,
      },
    ],
  },
...
const renderers = {
  cover: (ctx, data) => {
    ...
    wrapText(ctx, data.subtitle || "", tx, ruleY + 44, maxW, 50);
  ...
  framework: (ctx, data, slideNum) => {
    ...
    const labelFont = "500 28px 'JetBrains Mono', monospace";
  ...
  numbered_list: (ctx, data, slideNum) => {
    ...
    items.forEach((item, i) => {
      ...
      if (item.body) {
        ...
        wrapText(ctx, item.body, textX, baseY + 52, textW, 36);
      }
  ...
  quote: (ctx, data, slideNum) => {
    ...
    const qLines = wrapText(
      ctx,
      data.quote_text || "Your quote here.",
      C.contentStart,
      440,
      740,
      46,
  ...
  section_divider: (ctx, data) => {
    ...
    ctx.fillText(
      (data.part_label || "PART ONE").toUpperCase(),
      C.contentStart,
      440,
    );
  ...
  two_up: (ctx, data, slideNum) => {
    ...
    [
      [data.item1_title, data.item1_body, item1Y],
      [data.item2_title, data.item2_body, item2Y],
    ].forEach(([title, body, y], i) => {
      // Decorative number
      ctx.save();
      ctx.fillStyle = C.red;
      ctx.globalAlpha = 0.25;
      ...
      if (body) {
        ...
        wrapText(ctx, body, textX, y + 64, textW, 38);
      }
    });
  ...
  three_up: (ctx, data, slideNum) => {
    ...
    const cols = [
      C.contentStart,
      C.contentStart + colW + gutter,
      C.contentStart + (colW + gutter) * 2,
    ];
    ...
    cols.forEach((colX, i) => {
      ...
      wrapText(ctx, body, colX, titleY + 32, colW, 32);
    });
  },
  ...
  checklist: (ctx, data, slideNum) => {
    ...
    wrapText(
      ctx,
      data.headline || "Do this, not that",
      C.contentStart,
      180,
      C.contentEnd - C.contentStart,
      76,
    ...
    const dontItems = [data.dont1, data.dont2, data.dont3, data.dont4].filter(
      Boolean,
    );
    ...
    doItems.forEach((item, i) => {
      ...
      ctx.fillStyle = C.ink;
      ctx.font = "400 26px 'Newsreader', Georgia, serif";
      wrapText(ctx, item, col1X + 32, y + 14, colW - 36, 34);
    });
    ...
    dontItems.forEach((item, i) => {
      ...
      ctx.fillStyle = C.grey;
      ctx.font = "400 26px 'Newsreader', Georgia, serif";
      wrapText(ctx, item, col2X + 32, y + 14, colW - 36, 34);
    });
  },
...
async function exportPDF(slides) {
  ...
  for (let i = 0; i < slides.length; i++) {
    ...
    const s = slides[i];
    const showNum = !["cover", "cta", "punchline", "section_divider"].includes(
      s.template,
    );
...
export default function App() {
  ...
  const showSlideNum = ![
    ...
    "punchline",
    "section_divider",
  ].includes(currentSlide.template);
